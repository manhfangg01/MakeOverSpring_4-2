                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="order" items="${orders}">       <!-- Một vòng lặp lấy ra các order-->
                                        <tr>
                                        ...
                                        <c:forEach var="orderDetail" items="${order.orderDetails}">     <!-- Một vòng lặp nữa để hiển thị các chi tiết bên trong Order-->
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/images/productImage/${orderDetail.product.image}"
