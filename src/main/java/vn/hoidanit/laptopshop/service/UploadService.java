...
public class UploadService {
    ...
    public String handleUploadSingleFile(MultipartFile file, String targetFolder) {
        if (file.isEmpty())
            return ""; // Trong trường hợp người dùng không tải ảnh lên thì ta cũng sẽ không lưu
        String finalName = "";
        try {
    ...
    public String handleUploadSingleFileForProduct(MultipartFile file, String targetFolder) {
        if (file.isEmpty())
            return ""; // Trong trường hợp người dùng không tải ảnh lên thì ta cũng sẽ không lưu
        String finalName = "";
        try {
